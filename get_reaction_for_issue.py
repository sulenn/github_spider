...
THREAD_NUM = 10
base_path = "/home/qiubing/github/reactions/issue"
        ...
        while True:
            try:
                ...
                while True:
                    ...
                    # combine url
                    url = "https://api.github.com/repos/" + owner + "/" + repo + "/issues" + "/" + str(number) + "/reactions"
                    ...
                    try:
                        ...
                        sum += length
                        if length == 0:
                            print "finish, comment " + str(number) + " has reactions: " + str(sum)
                            self.q.task_done()
                            break
                                ...
                                if insert_dict is not None:
                                    cur.execute("insert into github_reaction "
                                                ...
                                                (insert_dict["id"], number, insert_dict["user_login"],
                                                 owner, repo, base.time_handler(insert_dict["created_at"]), 1,
                                                 insert_dict["content"]))
                                    db.commit()
                ...
                print str(e) + "qiubing" # unexpected error, don't interrupt the program
